...
public class CourseRegistrationController {
    ...
    public String availableCourses(Authentication authentication, Model model) {
        ...
        Set<Long> enrolledCourseIds = enrollmentService.getStudentEnrollments(student.getStudentId()).stream()
                .map(e -> e.getCourse().getId()).collect(Collectors.toSet());
    ...
    public String registerCourse(@PathVariable Long courseId, Authentication authentication,
        ...
        try {
            ...
            courseService.getCourseById(courseId).ifPresentOrElse(course -> {
                try {
    ...
    public String dropCourse(@PathVariable Long enrollmentId, RedirectAttributes redirectAttributes) {
        try {
